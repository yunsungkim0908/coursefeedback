...
import { Table, Button, Dropdown, OverlayTrigger } from 'react-bootstrap'
  ...
  return (
    ...
    <div className="card-body">
      ...
      <ul>
        ...
        <li>Please <span style={{color: "blue"}}><b>email the course ID</b></span> to the HRCE admin (<a href="mailto:hrcf@cs.stanford.edu">hrcf@cs.stanford.edu</a>) to get the course approved for survey.</li>
